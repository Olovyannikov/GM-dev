...
export const supportedEsimDevices : SupportedEsimDevicesModel = {
    ...
    'Смартфон' : [
        {
            brand : 'Apple',
            devices: ['iPhone Xs', 'iPhone Xs Max','iPhone Xr', 'iPhone 11', 'iPhone 11 Pro', 'iPhone 11 Pro Max', 'iPhone SE (2020)', 'iPhone 12', 'iPhone 12 Pro', 'iPhone 12 Mini', 'iPhone 12 Pro Max'],
        },
        {
            brand : 'Samsung',
            devices : ['Samsung Galaxy S20', 'Samsung Galaxy S20+', 'Samsung Galaxy S20 Ultra', 'Samsung Galaxy S21', 'Samsung Galaxy S21+', 'Samsung Galaxy S21 Ultra', 'Samsung Galaxy Z Fold3','Samsung Galaxy Z Fold2', 'Samsung Fold 5G', 'Galaxy Z Flip']
        },
        {
            brand : 'Google',
        ...
        {
            brand : 'OPPO',
            devices : ['Oppo Find X3', 'Oppo Find X3 Pro']
        }
    ]
}
